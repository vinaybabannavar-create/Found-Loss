...
const PostFound = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Found item posted successfully! People looking for this item will be able to contact you.');
      navigate('/my-items');
    } catch (error) {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <h1 className="text-3xl font-display font-bold text-slate-900">Post Found Item</h1>
          </div>
          <p className="text-slate-600">
            Help someone recover their lost item by providing detailed information
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Provide detailed description: brand, model, size, unique features, condition, etc."
                  data-testid="found-description-input"
                />
                {errors.description && <p className="text-red-500 text-sm mt-1">{errors.description}</p>}
                <p className="text-sm text-slate-500 mt-1">
                  Tip: Include unique features or damages to help legitimate owners identify their item
                </p>
              </div>
                ...
                <div className="space-y-2">
                  <div className="flex space-x-2">
                    <Input
                      ...
                      placeholder="e.g., Central Park bench near playground, Mall parking lot"
                      data-testid="found-location-input"
                    />
                    <Button
                      type="button"
                      variant="outline"
              ...
              <div>
                ...
                />
                <p className="text-sm text-slate-500 mt-1">
                  Upload your image to a service like Imgur or Google Drive and paste the public URL here
                </p>
              </div>
              ...
              <div className="flex space-x-4 pt-6">
                ...
                <Button
                  ...
                  data-testid="post-found-submit-btn"
                >
                  {loading ? (
        ...
        <Card className="glass-card mt-6">
          <CardContent className="p-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-semibold text-slate-900 mb-1">Posting Tips</h4>
                <ul className="text-sm text-slate-600 space-y-1">
                  <li>• Be as detailed as possible to help legitimate owners identify their item</li>
                  <li>• Include unique features, damages, or distinguishing marks</li>
                  <li>• Choose a safe, public location for item return</li>
